...
Now with custom Jappix installation support.
...
= 5.6.0 =
* Removed old webchat dep for work when old is removed

= 5.5.0 =
* Performace improve

= 5.4.5 =
* move to oldwebchat.chatme.im
...
= 5.3.3 =
* Fix Status widget and shortcode with new server setting
...
= 5.2.8 =
* Ready for new languages pack

= 5.2.7 =
* CDN

= 5.2.6 =
* Auto Languages Setting

= 5.2.5 =
* Local Bind server support

= 5.2.4 =
* Some Fix

= 5.2.3 =
* Add Domain service link
...
= 5.0 =
* Add Shortocode function
* Updated Italian Language
* New Class folder for extensions

= 4.3.9 =
* Admin Page Fix

= 4.3.8 =
* Chat Room Password option
...
* fix bug of custom style
* updated italian languages
* add new string to french languages

= 4.3.5 =
* add chatme_cache variable
* add variable for priority
...
* add new option for hide chat to mobile users
...
= 4.3.2 =
* Bug fix
* Add chat_actual filter for custom setting array

= 4.3.1 =
* Add resource 
* add chat_html filter for more custom options

= 4.3.0 =
* Add custom CSS option
* Add Custom Icon 
* Resize URL input
* URL input are now type=url
...
= 4.2.3 =
* Use the nickname of logged wordpress user
...
= 4.0.1 = 
* New WebSocket and Bind server

= 4.0.0 =
* Jappix Mini is now local installed and integrate in plugin
* no external url requeired
* static version of Jappix Mini
...
= 2.2.2 = 
* More Custom Installation Option

= 2.2.1 = 
* Insert Custom Jappix Installation URL Field (sorry)

= 2.2.0 =
* Custom Jappix Installation support
...
= 2.1.0 = 
* Personal Hosted Domains Support
